=== Plugin Name ===
Contributors: shockware, baden03, szepe.viktor, xsonic, sanidm, imelgrat, positive-medium
...
= 2.6.1 =
* Fix PHP 8.0 compatibility by replacing deprecated create_function()
* Add GitHub Plugin URI for updater compatibility
